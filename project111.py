...
print("Population Stdev Deviation --> ", std_deviation)
...
print("First Stdev Deviation --> ", first_std_deviation_start,", ", first_std_deviation_end)
print("Second Stdev Deviation --> ", second_std_deviation_start,", ", second_std_deviation_end)
print("Third Stdev Deviation --> ", third_std_deviation_start,", ", third_std_deviation_end)
